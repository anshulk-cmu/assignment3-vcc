#!/bin/bash
# ============================================================
# Assignment 3 - EC2 User Data Bootstrap Script
...
"""
Assignment 3 - Sample FastAPI Microservice (AWS EC2 Instance)
CSL7510 - Virtualization and Cloud Computing
Anshul Kumar (M25AI2036)

This is the same app running on the local VM,
deployed here automatically via cloud bursting.
"""
...
app = FastAPI(title="Assignment 3 - Cloud Burst Demo (EC2)")
