"""
Assignment 3 - Sample FastAPI Microservice
CSL7510 - Virtualization and Cloud Computing
Anshul Kumar (M25AI2036)

This app runs on both the local VirtualBox VM and the AWS EC2 instance.
It identifies where it's running so you can prove cloud bursting in your demo.
"""
...
app = FastAPI(title="Assignment 3 - Cloud Burst Demo")

# Detect environment: check if running on EC2 or local VM
def get_environment():
    """Detect whether we're on local VirtualBox VM or AWS EC2."""
    try:
        # EC2 instances have this metadata endpoint
...
def info():
    ...
    return {
        ...
        "assignment": "Assignment 3 - Hybrid Auto-Scaling",
        "student": "Anshul Kumar (M25AI2036)",
        "description": "Local VM monitors CPU/memory. When usage > 75%, "
